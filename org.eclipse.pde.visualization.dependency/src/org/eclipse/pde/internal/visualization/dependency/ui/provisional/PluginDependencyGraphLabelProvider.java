...
public class PluginDependencyGraphLabelProvider extends AbstractDependencyVisualizationLabelProvider {

	private final DependenciesLabelProvider pdeLabelProvider = new DependenciesLabelProvider(true);
		
	public PluginDependencyGraphLabelProvider(GraphViewer viewer, IDependencyVisualizationView view,
	...
	public Image getImage(Object element) {
		...
		if (element instanceof IPDEDependencyVertex){
			...
			if (modelObject instanceof BundleSpecification) {
